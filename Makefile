...
btchip_setup: commands/btchip_setup.o $(OBJS_COMM)
	gcc commands/btchip_setup.o $(OBJS_COMM) -o bin/btchip_setup -l usb-1.0

btchip_setup_forward: commands/btchip_setup_forward.o $(OBJS_COMM)
	gcc commands/btchip_setup_forward.o $(OBJS_COMM) -o bin/btchip_setup_forward -l usb-1.0

btchip_setup_143: commands/btchip_setup_143.o $(OBJS_COMM)
	gcc commands/btchip_setup_143.o $(OBJS_COMM) -o bin/btchip_setup_143 -l usb-1.0

btchip_verifyPin: commands/btchip_verifyPin.o $(OBJS_COMM)
	gcc commands/btchip_verifyPin.o $(OBJS_COMM) -o bin/btchip_verifyPin -l usb-1.0

btchip_getOperationMode: commands/btchip_getOperationMode.o $(OBJS_COMM)
	gcc commands/btchip_getOperationMode.o $(OBJS_COMM) -o bin/btchip_getOperationMode -l usb-1.0

btchip_setOperationMode: commands/btchip_setOperationMode.o $(OBJS_COMM)
	gcc commands/btchip_setOperationMode.o $(OBJS_COMM) -o bin/btchip_setOperationMode -l usb-1.0

btchip_getWalletPublicKey: commands/btchip_getWalletPublicKey.o $(OBJS_COMM)
	gcc commands/btchip_getWalletPublicKey.o $(OBJS_COMM) -o bin/btchip_getWalletPublicKey -l usb-1.0

btchip_getTrustedInput: commands/btchip_getTrustedInput.o  btchipTrustedInput.o $(OBJS_COMM)
	gcc commands/btchip_getTrustedInput.o btchipTrustedInput.o $(OBJS_COMM) -o bin/btchip_getTrustedInput -l usb-1.0

btchip_startUntrustedTransaction: commands/btchip_startUntrustedTransaction.o  btchipTrustedInput.o $(OBJS_COMM)
	gcc commands/btchip_startUntrustedTransaction.o btchipTrustedInput.o $(OBJS_COMM) -o bin/btchip_startUntrustedTransaction -l usb-1.0

btchip_finalizeInput: commands/btchip_finalizeInput.o $(OBJS_COMM)
	gcc commands/btchip_finalizeInput.o $(OBJS_COMM) -o bin/btchip_finalizeInput -l usb-1.0

btchip_finalizeInputFull: commands/btchip_finalizeInputFull.o $(OBJS_COMM)
	gcc commands/btchip_finalizeInputFull.o $(OBJS_COMM) -o bin/btchip_finalizeInputFull -l usb-1.0

btchip_untrustedHashSign: commands/btchip_untrustedHashSign.o $(OBJS_COMM)
	gcc commands/btchip_untrustedHashSign.o $(OBJS_COMM) -o bin/btchip_untrustedHashSign -l usb-1.0

btchip_signMessagePrepare: commands/btchip_signMessagePrepare.o $(OBJS_COMM)
	gcc commands/btchip_signMessagePrepare.o $(OBJS_COMM) -o bin/btchip_signMessagePrepare -l usb-1.0

btchip_signMessageSign: commands/btchip_signMessageSign.o $(OBJS_COMM)
	gcc commands/btchip_signMessageSign.o $(OBJS_COMM) -o bin/btchip_signMessageSign -l usb-1.0

btchip_composeMofNStart: commands/btchip_composeMofNStart.o $(OBJS_COMM)
	gcc commands/btchip_composeMofNStart.o $(OBJS_COMM) -o bin/btchip_composeMofNStart -l usb-1.0

btchip_composeMofNContinue: commands/btchip_composeMofNContinue.o $(OBJS_COMM)
	gcc commands/btchip_composeMofNContinue.o $(OBJS_COMM) -o bin/btchip_composeMofNContinue -l usb-1.0

btchip_importPrivateKey: commands/btchip_importPrivateKey.o $(OBJS_COMM)
	gcc commands/btchip_importPrivateKey.o $(OBJS_COMM) -o bin/btchip_importPrivateKey -l usb-1.0

btchip_getPublicKey: commands/btchip_getPublicKey.o $(OBJS_COMM)
	gcc commands/btchip_getPublicKey.o $(OBJS_COMM) -o bin/btchip_getPublicKey -l usb-1.0

btchip_deriveBip32Key: commands/btchip_deriveBip32Key.o $(OBJS_COMM)
	gcc commands/btchip_deriveBip32Key.o $(OBJS_COMM) -o bin/btchip_deriveBip32Key -l usb-1.0

btchip_signImmediate: commands/btchip_signImmediate.o $(OBJS_COMM)
	gcc commands/btchip_signImmediate.o $(OBJS_COMM) -o bin/btchip_signImmediate -l usb-1.0

btchip_verifyImmediate: commands/btchip_verifyImmediate.o $(OBJS_COMM)
	gcc commands/btchip_verifyImmediate.o $(OBJS_COMM) -o bin/btchip_verifyImmediate -l usb-1.0

btchip_getRandom: commands/btchip_getRandom.o $(OBJS_COMM)
	gcc commands/btchip_getRandom.o $(OBJS_COMM) -o bin/btchip_getRandom -l usb-1.0

btchip_getFirmwareVersion: commands/btchip_getFirmwareVersion.o $(OBJS_COMM)
	gcc commands/btchip_getFirmwareVersion.o $(OBJS_COMM) -o bin/btchip_getFirmwareVersion -l usb-1.0

btchip_util_runScript: utils/btchip_util_runScript.o $(OBJS_COMM)
	gcc utils/btchip_util_runScript.o $(OBJS_COMM) -o bin/btchip_util_runScript -l usb-1.0
